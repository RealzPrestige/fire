            ...
            if (module.render.GetSwitch()) {
                ...
                switch (module.colorMode.GetCombo()) {
                    ...
                    case "Fade":
                        ...
                        color = new Color(module.safety(module.col[0] / 255.0f), module.safety(module.col[1] / 255.0f), module.safety(module.col[2] / 255.0f), module.safety(module.col[3] / 255.0f));
                        break;
                }
