...
public class Chams extends Module {
    ...
    public final Switch animateVertical = Menu.Switch("Animate Vertical", false).panel("PopChams").visibility(z -> popChams.GetSwitch());
    public final Slider verticalAnimationSpeed = Menu.Slider("Vertical Animation Speed", 2.5f, -5.0f, 5.0f).panel("PopChams").visibility(z -> popChams.GetSwitch() && animateVertical.GetSwitch());
