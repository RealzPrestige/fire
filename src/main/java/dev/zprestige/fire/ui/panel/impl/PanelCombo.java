...
public class PanelCombo extends PanelSetting {
    ...
    public void render(int mouseX, int mouseY) {
        ...
        Main.fontManager.drawStringWithShadow(setting.GetCombo(), (x + width - Main.fontManager.getStringWidth(setting.GetCombo()) * 0.73f) / 0.73f, (y + (height / 2f) - Main.fontManager.getFontHeight() / 2.0f) / 0.73f, new Color(col[0], col[1], col[2], 0.5f).getRGB());
